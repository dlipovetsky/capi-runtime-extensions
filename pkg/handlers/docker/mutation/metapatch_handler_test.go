...
import (
	...
	containerdrestarttests "github.com/d2iq-labs/cluster-api-runtime-extensions-nutanix/pkg/handlers/generic/mutation/containerdrestart/tests"
...
func TestGeneratePatches(t *testing.T) {
	...
	containerdrestarttests.TestGeneratePatches(
		t,
		metaPatchGeneratorFunc(mgr),
	)
}
